	...
	public class PushyNetworkCampaignWebModelStatusChanger
	{
		...
		public void SendReportIfThereAreChanges()
		{
			...
			if (this._network.Clicks != this._network.WebModel.Clicks)
				...
				result = true;
			else if (this._network.IsPaused != this._network.WebModel.IsPaused)
				result = true;
			...
			this._network.WebModel.IsPaused = this._network.IsPaused;
			...
			if(result)
				...
				{
					LinkName = this._network.PushyCampaign.Link.Name,
